...
import (
	...
	"github.com/local/node-hunter/internal/pipeline"
)
...
func main() {
	...
	slog.Info("node-hunter starting", "config", cfgPath, "sources", len(cfg.EnabledSources()))
...
func printSummary(res *model.Result) {
	fmt.Println()
	fmt.Println("========== node-hunter summary ==========")
