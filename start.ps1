...
go build -o nodeharvest-server.exe ./cmd/server
...
Write-Host "按 Ctrl+C 只停前端；后端在最小化窗口中，可从任务管理器结束 nodeharvest-server" -ForegroundColor Yellow
Write-Host ""
